...
##  Written by: Bryan Jones and Mark Webb
    def collectMetrics(self):
        pitch = self.pitchProc()
        pitchIndexes = [5, 10, 15, 20, 25, 30, 35, 40, 45, 50]
        pitch = pitch[pitchIndexes]
        ...
        toneIndexes = [15, 30, 45, 60, 75, 90, 105, 120, 135, 150]
        tone = tone[toneIndexes]

        volume = self.volumeProc()
        volumeIndexes = [1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000]
        volume = volume[volumeIndexes]
